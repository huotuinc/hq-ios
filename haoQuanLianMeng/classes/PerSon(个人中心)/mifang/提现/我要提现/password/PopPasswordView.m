...
-(id)initViewwithtype:(NSString *)type
{
    ...
    if(self)
    {
        ...
        UIView *view=[[UIView alloc]initWithFrame:CGRectMake((ScreenWidth-276)/2, (KScreenHeight - 158) * 0.5 - 60, 276, 158)];
...
//        disbtn.frame=CGRectMake(ScreenWidth-48, 74, 24, 24);
        ...
        [disbtn mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.left.mas_equalTo(view.mas_right).mas_offset(-12);
            make.bottom.mas_equalTo(view.mas_top).mas_offset(12);
        }];
