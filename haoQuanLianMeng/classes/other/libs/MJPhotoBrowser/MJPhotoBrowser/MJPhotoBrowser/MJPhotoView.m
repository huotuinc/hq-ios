...
- (void)photoStartLoad
{
    if (_photo.image) {
        ...
        [[SDWebImageManager sharedManager] loadImageWithURL:_photo.url options:SDWebImageRetryFailed|SDWebImageLowPriority progress:^(NSInteger receivedSize, NSInteger expectedSize, NSURL * _Nullable targetURL) {
