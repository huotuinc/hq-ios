...
#import "LHBCountDownManager.h"

@interface LHBCountDownManager ()

@property (nonatomic, strong) NSTimer *timer;

@end

@implementation LHBCountDownManager

+ (instancetype)manager {
    static LHBCountDownManager *manager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        manager = [[LHBCountDownManager alloc]init];
    });
    return manager;
}
